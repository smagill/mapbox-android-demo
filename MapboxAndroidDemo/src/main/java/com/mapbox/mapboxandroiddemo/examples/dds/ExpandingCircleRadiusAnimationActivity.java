    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(new Style.Builder().fromUri(Style.DARK)
            ...
            .withImage(POWER_PLANT_SYMBOL_ICON_ID, Objects.requireNonNull(BitmapUtils.getBitmapFromDrawable(
              ContextCompat.getDrawable(ExpandingCircleRadiusAnimationActivity.this,
  ...
  private void animateCircleRadius() {
    ...
    expandingCircleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      ...
      public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        Log.d(TAG, "onAnimationUpdate: newPulsingRadiusValue = " + newPulsingRadiusValue);
